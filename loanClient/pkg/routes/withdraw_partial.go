...
func WithdrawPartial(w http.ResponseWriter, r *http.Request) {
	...
	// convert amount to billion units
	...
	request.Amount, err = ConvertDecimalAmount(request.Amount)
	if err != nil {
		http.Error(w, "Failed to convert decimal amount", 500)
	}
